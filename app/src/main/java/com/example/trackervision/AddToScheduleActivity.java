...
public class AddToScheduleActivity extends AppCompatActivity {
    ...
    public void writeNewScheduleEntry() {
        ...
        if (TextUtils.isEmpty(showNameText.getText())){
            Toast.makeText(this, "Please enter a show name.", Toast.LENGTH_SHORT).show();
            return;
        }
        if (TextUtils.isEmpty(seasonNumberText.getText())){
            Toast.makeText(this, "Please enter a season number.", Toast.LENGTH_SHORT).show();
            return;
        }
        if (TextUtils.isEmpty(episodeNumberText.getText())){
            Toast.makeText(this, "Please enter an episode number.", Toast.LENGTH_SHORT).show();
            return;
        }
